import sys, copy
#Creates a display of a chessboard that contains the starting positions of all pieces
...
#Prints the sample chessboard above
...
#A list of responses and the corresponding actions
    if response[0] == 'move':
